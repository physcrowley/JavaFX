...
public class HelloFX extends Application { 
    ...
    /**
     * Main Java script... not required for running JavaFX since
     * the {@code stage.show()} method call in the overidden
     * {@code start()} method also runs the application.
     * <p>
     * This can be used for finer control in when to launch and stop windows
     * during the application and how to manage the shutdown using
     * an overidden {@code stop()} method.
     * 
